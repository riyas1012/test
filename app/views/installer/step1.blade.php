...
@section('content')
      <div class="col-lg-12">
        <p class="lead">Step 1 - Basic Settings</p>
      </div>
        ...
        <div class="col-lg-8"  style="min-height:350px;">
          ...
          <form role="form" method="POST" action="{{ web_url(); }}/install">
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" name="website_title" placeholder="Name of your App">
			  </div>
			  <div class="form-group">
			    <label for="exampleInputPassword1">Domain</label>
			    <input type="text" class="form-control"  name="url" placeholder="Domain name">
			  </div>
			  <div class="form-group">
