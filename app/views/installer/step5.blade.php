...
@section('content')
      ...
      <div class="row marketing">
        ...
        <div class="form-group" >
          ...
          <input type="text" class="form-control"  name="email_name" placeholder="Display Name">
        </div>

        <div class="form-group mandrill" style="display:none">
          <label for="exampleInputPassword1">Mandrill Secret</label>
          <input type="text" class="form-control"  name="mandrill_secret" placeholder="Mandrill Secret">
        </div>			 
