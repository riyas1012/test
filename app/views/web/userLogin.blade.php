      ...
      *********************************************************************************************************************************************************** -->
      ...
      <div id="login-page">
        <div class="container">
              ...
              <form class="form-login"  method="POST" action="<?php echo web_url(); ?>/user/verify" >
                ...
                <div class="login-wrap">
                    ...
                    <div class="registration">
                        ...
                        <a class="" href="<?php echo web_url(); ?>/user/signup">
                            Create an account
                        </a>
                    </div>
                  ...
                  <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal" class="modal fade">
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <form method="POST" action="<?php echo web_url(); ?>/user/forgot-password">
