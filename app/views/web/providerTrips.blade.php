...
<div class="col-lg-12 col-sm-12 mb">
	...
	<div class="form-panel">
	  ...
	  <form class="form-inline" role="form" method="get" action="<?php echo web_url(); ?>/provider/trips">
	      ...
	      <button type="submit" name="submit" value="filter" class="btn btn-theme"><i class="fa fa-filter fa-x"></i> Filter Results</button>
	      <button type="submit" name="submit" value="export" class="btn btn-theme"><i class="fa fa-download fa-x"></i> Download Report</button>
	  </form>
	</div>
</div>
...
<div class="col-md-3 col-sm-3 mb" style="height:150px;">
	...
	<footer>
		<div class="centered">
			<h5><i class=""></i> {{ number_format((float)$total_distance, 2, '.', '') }} Miles</h5>
		</div>
	</footer>
	</div>
</div>
<div class="col-md-3 col-sm-3 mb" style="height:150px;">
	...
	<footer>
		<div class="centered">
			<h5><i class=""></i>{{ number_format((float)$average_rating, 2, '.', '') }}</h5>
		</div>
	</footer>
	</div>
</div>
...
<div class="col-md-3 col-sm-3 mb" style="height:150px;">
	...
	<footer>
		<div class="centered">
			<h5><i class=""></i> $ {{ number_format((float)$total_earnings, 2, '.', '') }}</h5>
		</div>
	</footer>
	</div>
</div>
...
<script type="text/javascript">
	...
	$(function() {
		$( ".trip-basic" ).click(function() {
			...
			var id = $(this).data('id');
			$this.next().toggle();
			$.ajax({ url: "<?php echo web_url(); ?>/provider/trip/"+id,
	         type: 'get',
	         success:
	         function(msg) {
		         if(msg === 'false'){
        ...
        tour.addSteps([
          {
            ...
            content: "Click on profile to change your availability and other driver details",
