...
<html lang="en">
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <a href="<?php echo web_url(); ?>/provider/trips" class="logo"><b>Uber For X</b></a>
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="{{ web_url() }}/provider/logout">Logout</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="{{ web_url() }}/provider/trips"><img src="<?= Session::get('walker_pic')?Session::get('walker_pic'):asset_url().'/web/default_profile.png' ?>" class="img-circle" width="60"></a></p>
              	  <h5 class="centered">{{ Session::get('walker_name') }}</h5>
                  <?php if (  Session::get('is_approved') == 1) { ?>
                     <p  class="centered"><a href="{{ web_url() }}/provider/documents"><span class="label label-success">Approved</span></a></p>
                  <?php }else{ ?>
                  <p  class="centered"><a href="{{ web_url() }}/provider/documents"><span class="label label-danger">Un Approved</span></a></p>
                 	<?php } ?>

                  <li class="mt">
                      <a href="{{ web_url() }}/provider/trips">
                          <i class="fa fa-car"></i>
                          <span>My Trips</span>
                      </a>
                  </li>
                  ...
                  <li class="" id="flow21">
                      ...
                      <a href="{{ web_url() }}/provider/profile">
                          <i class="fa fa-user"></i>
                          <span>Profile</span>
                      </a>
                  </li>
                  <li class="">
                      <a href="{{ web_url() }}/provider/documents">
                  ...
                  <li class="">
                      <a href="{{ web_url() }}/provider/tripinprogress">
                  ...
                  <li class="">
                      <a href="{{ web_url() }}/provider/logout">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">New Trip Request</h4>
      </div>
      <div class="modal-body">
        <p>You got a new trip request. Please respond quickly&hellip;</p>
  ...
  $(document).ready(function () {
        ...
        $.ajax({
            url: '<?php echo web_url() ?>/provider/request',
            type: "GET",
            success: function (data) {
                var res = $.map(data, function(el) { return el; }); 
                if(res.length){
                  var requestId = res[1];
                  ...
                  var acceptUrl = "<?php echo web_url(); ?>/provider/request/accept/"+requestId;
                  var declineUrl = "<?php echo web_url(); ?>/provider/request/decline/"+requestId;
...
//$('#myModal').modal('show');
  ...
  <script type="text/javascript">
        ...
        function successFunction(position) {
            ...
            $.ajax({
                  type: 'get',
                  url: '<?php echo web_url(); ?>/provider/location/set/?lat='+lat+'&lng='+lng,
        ...
        tour.addSteps([
          {
            element: "#flow23", 
            title: "Accept Walk", 
            content: "Click on accept to accept the trip else reject the trip request", 
